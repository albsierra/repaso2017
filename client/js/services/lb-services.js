      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/CoffeeShops/:id",
          { 'id': '@id' },
          {
             ...
             * @description
             *
             * Conocer si las cafeterías están abiertas
             *
             * @param {Object=} parameters Request parameters.
             *
             *   This method does not accept any parameters.
             ...
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{number}` - Identificador de la cafetería
             *
             * @param {function(Object,Object)=} successCb
             *   Success callback with two arguments: `value`, `responseHeaders`.
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.CoffeeShop#enCiudad
             * @methodOf lbServices.CoffeeShop
             *
             * @description
             *
             ...
             *   from the server.
             *
             * El array con el nombre de las cafeterías
             */
            "enCiudad": {
              isArray: true,
              url: urlBase + "/CoffeeShops/enCiudad",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.CoffeeShop#prototype$getCity
             * @methodOf lbServices.CoffeeShop
             *
             * @description
             *
             ...
             * Data properties:
             *
             *  - `ciudad` – `{string=}` - Ciudad en la que se encuentra la cafetería
             */
            "prototype$getCity": {
              url: urlBase + "/CoffeeShops/:id/getCity",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.CoffeeShop#competencia
             * @methodOf lbServices.CoffeeShop
             *
             * @description
             *
             ...
             * @param {Object=} parameters Request parameters.
             *
             *  - `nombre` – `{string}` - El nombre de la cafetería de la que queremos saber su competencia
             *
             * @param {function(Array.<Object>,Object)=} successCb
             *   Success callback with two arguments: `value`, `responseHeaders`.
             *
             ...
             *   from the server.
             *
             * Las cafeterías que están en la misma ciudad
             */
            "competencia": {
              isArray: true,
              url: urlBase + "/CoffeeShops/competencia",
              method: "GET",
            },
